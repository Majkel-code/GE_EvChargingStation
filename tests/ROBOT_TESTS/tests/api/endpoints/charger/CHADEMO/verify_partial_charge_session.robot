...
*** Test Cases ***
Verify VEHICLE CHADEMO charge to 80%
   Log To Console    \nSending Request to ${GLOBAL_ENDPOINT_CHARGER_CHARGE_SESSION_CHADEMO_CUSTOM_PERCENT}${GLOBAL_CHADEMO_PERCENT_80}\n
    ${response}    POST    url=${GLOBAL_ENDPOINT_CHARGER_CHARGE_SESSION_CHADEMO_CUSTOM_PERCENT}${GLOBAL_CHADEMO_PERCENT_80}    expected_status=200
    ...
    IF    ${session_end} == True
        ...
        Should Be Equal As Numbers    ${battery_level}    ${GLOBAL_CHADEMO_PERCENT_80}
        ...
        ${expected_battery_level}    Calculate Expected KW Level    ${GLOBAL_CHADEMO_PERCENT_80}    ${max_battery}
