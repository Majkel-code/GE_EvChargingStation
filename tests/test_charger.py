...
class TestChargerEndpoints(TestConfigureServer):
    ...
    def setUpClass(self) -> None:
        ...
        self.CHARGER_EVERY_SETTING = self.test_config[
            'CHARGER_CHECK_EVERY_SETTING'
        ]
        print('charger')
    ...
    def test_check_specific_value(self):
        ...
        for param in self.CHARGER_EVERY_SETTING:
            ...
            print(
                f"take_specific_setting test config: {self.test_config['CHARGER_PROPER_VALUE'][f'{param}']}"
            )
            assert (
                response_take_specific_setting.json()
                == self.test_config[f'CHARGER_PROPER_VALUE'][f'{param}']
            )
    ...
    def test_change_param(self):
        ...
        print(
            f"{self.test_config['CHARGER_CHANGE_VALUE']['key']}={self.test_config['CHARGER_CHANGE_VALUE']['value']}"
        )
